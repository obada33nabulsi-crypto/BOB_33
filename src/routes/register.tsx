...
export const Route = createFileRoute("/register")({
  head: () => ({ meta: [{ title: "Create Account — NexusStore" }, { name: "description", content: "Create a NexusStore account." }] }),
...
function RegisterPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(true);
      toast.success(`Welcome to NexusStore, ${u.username}! 🎮`);
  ...
  return (
    <AuthLayout>
      ...
      <form onSubmit={onSubmit} className="space-y-3">
        ...
        <p className="text-center font-heading text-base text-muted-foreground pt-1">
